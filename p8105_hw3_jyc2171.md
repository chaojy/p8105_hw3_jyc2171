...
values are “0” (77.4%) followed by “NA” (14.7%). For both temperature
variables (tmax and tmin), NA is the most common observation, by far
(43.7% for both tmax and tmin variables). For the precipitation and snow
depth variables, the two most common observations are “0” followed by
“NA”.
...
to get what you want. Only care about Jan and July - filter() function
...
## In the above code, I am working with a random sample of the ny_noaa dataset by using sample_n() function.  This saves time running the code for such a large dataset  
```
...
<img src="p8105_hw3_jyc2171_files/figure-gfm/unnamed-chunk-16-1.png" width="90%" />
...
temperature in July. There appear to be a few outliers in the data. In
January 1982, there was a mean tmax value of around -13 degrees C. In
January of 1993, there was another mean tmax value of around -8 C. In
January of 2005, there was another particularly cold mean tmax value of
-12 C. One example of a particularly warm mean tmax in January was in
1984, where there was a point value of around +9 C, but there were
multiple point values that were clustered higher. For the month of July,
there was one ostensibly colder point value of around 14 C.
...
<img src="p8105_hw3_jyc2171_files/figure-gfm/unnamed-chunk-18-1.png" width="90%" />
